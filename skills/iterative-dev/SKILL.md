...
**Timer / Worker Polling:** see worker rules (opus-workers-2). Short: set ONE background timer based on estimated work time (default ~3min), check status after fire, then decide.
