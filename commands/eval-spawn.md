...
TASK="Activate Skill('iterative-dev:eval-agent') with arguments: <project_path> session. Non-interactive: write all proposals to the plan file (not chat). Schreibe auf Deutsch.
